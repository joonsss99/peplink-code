...
tar -cf - usr/lib | tar -xf - -C $abspath/$MNT/
...
$HOST_PREFIX-strip --strip-unneeded ${abspath}/${MNT}/usr/lib/xtables/*.so* ${abspath}/${MNT}/lib/libxtables*.so* ${abspath}/${MNT}/sbin/xtables-multi
